...
// Instagram Scheduler Types
export type InstagramPostStatus = 'pending' | 'publishing' | 'published' | 'failed' | 'cancelled';
...
export interface ScheduledPost {
  ...
  aspectRatio: InstagramAspectRatio | null;
...
export interface InstagramUsageInfo {
  isPro: boolean;
  monthlyCount: number;
  monthlyLimit: number;
  remaining: number;
